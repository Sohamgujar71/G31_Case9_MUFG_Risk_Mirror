...
Risk-Mirror is an end-to-end AI project that predicts **Health Risk** and **Financial Risk**, provides detailed analysis dashboards, and integrates a **custom RAG-powered chatbot** to answer user queries.  
...
```bash
git clone https://github.com/Sohamgujar71/G31_Case9_MUFG_Risk_Mirror.git
cd Risk-Mirror
```
